...
<div>
     <div className= " bg-[#06091A] text-white pt-50  relative mt-[70%] md:mt-[20%]">
            <div className="w-11/12 mx-auto p-4 bg-white/15  border-2 border-green-500 rounded-3xl absolute left-1/2 -translate-x-1/2 -top-1/5">
                <div
